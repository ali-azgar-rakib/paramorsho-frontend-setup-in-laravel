      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="header__logo" style="text-align: center">
            <a href="#" onclick="myFunction()"><img src="{{asset('frontend_assets')}}/img/logo/logo-1.png" height="100"
                alt="" /></a>
          </div>
        </div>
        <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <p>
            Binary Ocean IT built the Paramorsho - পরামর্শ app as a Commercial
            app. This SERVICE is provided by Binary Ocean IT and is intended
            for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Paramorsho -
            পরামর্শ unless otherwise defined in this Privacy Policy.
          </p>
        </div>
        ...
        <div class="col-lg-10 mx-auto">
          ...
          <p>
            ...
            do not hesitate to contact us at support@paramorsho.com.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-12">
          <div class="footer__widget">
            ...
            <div>
              <a href="https://play.google.com/store/apps/details?id=com.paramorsho.consultancy" onclick="myFunction()">
