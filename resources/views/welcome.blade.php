...
<body>
    ...
    <div id="preloder" v-if='isLoading'>
      ...
      <div class="preloader-main">
        <div class="preloader-image">
          <img src="{{ asset('frontend_assets') }}/img/logo/preloader/logo.png" alt="" />
          <div class="loader">
            <div class="load1"></div>
            <div class="load2"></div>
            <div class="load3"></div>
    ...
    <div v-else>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="header__logo" style="text-align: center">
                <a href="#" @click="myFunction()"><img src="{{ asset('frontend_assets') }}/img/logo/logo-1.png"
                    height="100" alt="" /></a>
              </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-9">
              ...
              <div class="hero__item set-bg" data-setbg="{{ asset('frontend_assets') }}/img/hero/a.png">
                <div class="hero__text">
                  <span>DOWNLOAD OUR APP</span>
                  <h2 id='text-not-changing'>PARAMORSHO</h2>
      ...
      <section class="consultant-section spad">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="corona-area-title text-center my-5">
          ...
          <div>
                ...
                <div class="consultant-card">
                  <div class="row">
                    <div class="col-lg-4 col-5">
                      <img width=" 100" src="{{ asset('frontend_assets') }}/img/consultants/doctor.jpg" alt="image" />
                    </div>
            ...
            <div class="row">
              <div class="col-6 col-lg-2 mx-auto my-3">
                <a href="javascript:void(0)" @click="myFunction()" class="btn-more-consultant">See More</a>
              </div>
            </div>
          </div>
          <!-- end doctor  -->
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="consultant-card">
                  <div class="row">
                    <div class="col-lg-4 col-5">
                      <img src="{{ asset('frontend_assets') }}/img/consultants/lawyer.png" alt="image" />
                    </div>
                    <div class="col-lg-8 col-7 p-2">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="consultant-card">
                  <div class="row">
                    <div class="col-lg-4 col-5">
                      <img src="{{ asset('frontend_assets') }}/img/consultants/psychologist.jpg" alt="image" />
                    </div>
                    <div class="col-lg-8 col-7 p-2">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="consultant-card">
                  <div class="row">
                    <div class="col-lg-4 col-5">
                      <img src="{{ asset('frontend_assets') }}/img/consultants/nutritionist.jpg" alt="image" />
                    </div>
                    <div class="col-lg-8 col-7 p-2">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="consultant-card">
                  <div class="row">
                    <div class="col-lg-4 col-5">
                      <img src="{{ asset('frontend_assets') }}/img/consultants/it.jpg" alt="image" />
                    </div>
                    <div class="col-lg-8 col-7 p-2">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="banner__pic">
                <img @click='myFunction' src="{{ asset('frontend_assets') }}/img/banner/2.png" alt="" />
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="banner__pic">
                <img @click='myFunction' src="{{ asset('frontend_assets') }}/img/banner/3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="blog__item">
                <div class="blog__item__pic">
                  <img src="{{ asset('frontend_assets') }}/img/blog/paramorsho-banner.jpg" alt="" />
                </div>
                <div class="blog__item__text">
                  ...
                  <h5>
                    <a href="#" @click="myFunction()">Paramorsho is a mobile app-based online consultation
                      service</a>
                  </h5>
                  <p>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer__about">
                <div class="footer__about__logo">
                  <a href="#"><img width="100" height="100" src="./{{ asset('frontend_assets') }}/img/logo/logo.png"
            ...
            <div class="col-lg-4 col-md-12">
              <div class="footer__widget">
                ...
                <div>
                  <a href="https://play.google.com/store/apps/details?id=com.paramorsho.consultancy" target="_blank">
                  ...
                  <a href="javascript:void(0)" @click="myFunction()">
                    <img src="./{{ asset('frontend_assets') }}/img/app-store-badge/app-store-badge/128x128.png" alt="" />
                  </a>
                </div>
                <!-- <form action="#">
  ...
  <script src="{{ asset('frontend_assets') }}/js/main2.js"></script>
